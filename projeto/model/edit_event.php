...
$query_event = "UPDATE events SET title=:title, color=:color, start=:start, end=:end, fk_idpaciente=:fk_idpaciente  WHERE id=:id";
...
$update_event->bindParam(':fk_idpaciente', $dados['fk_idpaciente']);
