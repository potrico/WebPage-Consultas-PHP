...
$query_event = "INSERT INTO events (title, color, start, end, fk_idpaciente) VALUES (:title, :color, :start, :end, :fk_idpaciente)";
...
$insert_event->bindParam(':fk_idpaciente', $dados['fk_idpaciente']);
