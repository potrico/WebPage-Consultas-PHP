                        ...
                        <div class="modal-body">
                            <div class="visevent">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-9" id="fk_idpaciente"></dd>
                            ...
                            <div class="formedit">
                                ...
                                <form id="editevent" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" id="title" placeholder="Título do evento"><br>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="fk_idpaciente" class="form-control" id="fk_idpaciente">
                                                
                                                <option value="">Selecione o paciente</option>
                                                <?php foreach($lista_pacientes as $paciente){?>
                                                    <option value="<?php echo $paciente->codigo; ?>" ><?php echo $paciente->nome; ?></option>
                                                <?php } ?>
                                            </select><br>
                                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form id="addevent" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Início do evento</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="start" class="form-control" id="start" onkeypress="DataHora(event, this)"><br>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Final do evento</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="end" class="form-control" id="end"  onkeypress="DataHora(event, this)"><br>
                                    </div>
                                </div>
